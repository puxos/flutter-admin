...
import '../../controller/other/fl_chart_controller.dart';
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    MyText.titleMedium("Fl Charts", fontSize: 18, fontWeight: 600),
                    MyBreadcrumb(
                      children: [MyBreadcrumbItem(name: 'ui'), MyBreadcrumbItem(name: 'Fl charts', active: true)],
                    ),
                  ],
                ),
              ),
                              ...
                              ? MyContainer.bordered(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    MySpacing.height(8),
                                    MyText.bodyMedium('x: ${controller.xValue.toStringAsFixed(1)}', fontWeight: 600),
                                    MyText.bodyMedium(
                                ...
                                LineChartData(
                                  ...
                                  titlesData: FlTitlesData(
                                    ...
                                    bottomTitles: AxisTitles(
                                      axisNameWidget: MyText.bodyMedium('2019', fontWeight: 600),
                                    ...
                                    leftTitles: AxisTitles(
                                      axisNameSize: 20,
                                      axisNameWidget: MyText.bodyMedium('Value'),
                                      sideTitles: SideTitles(
                                        showTitles: true,
                                        interval: 1,
                                        reservedSize: 40,
                                  ...
                                  barTouchData: BarTouchData(
                                    ...
                                    touchCallback: (FlTouchEvent event, response) {
                                      ...
                                      if (controller.touchedGroupIndex != -1) {
                                        var sum = 0.0;
                                        for (final rod
                                            in controller.showingBarGroups[controller.touchedGroupIndex].barRods) {
                                          sum += rod.toY;
                                        }
                                        final avg =
                                            sum /
                                            controller.showingBarGroups[controller.touchedGroupIndex].barRods.length;

                                        controller.showingBarGroups[controller.touchedGroupIndex] = controller
                                            .showingBarGroups[controller.touchedGroupIndex]
                                            .copyWith(
                                              barRods:
                                                  controller.showingBarGroups[controller.touchedGroupIndex].barRods.map(
                                                    (rod) {
                                                      return rod.copyWith(
                                                        toY: avg,
                      ...
                      child: MyContainer.bordered(
                        child: Column(
                          children: [
                            ...
                            MySpacing.height(8),
                            SizedBox(height: 300, child: BarChart(controller.barChartData)),
                          ],
                        ),
                      ),
                    ),
                              ...
                              child: BarChart(
                                BarChartData(
                                  ...
                                  extraLinesData: ExtraLinesData(
                                    horizontalLines: [
                                      HorizontalLine(y: 3.3, color: Colors.purple, strokeWidth: 1, dashArray: [20, 4]),
                                      HorizontalLine(y: 8, color: Colors.blue, strokeWidth: 1, dashArray: [20, 4]),
                                      HorizontalLine(y: 11, color: Colors.cyan, strokeWidth: 1, dashArray: [20, 4]),
                                    ],
                                  ),
                                ),
                              ),
                            ...
                            SizedBox(
                              ...
                              child: InkWell(
                                ...
                                child: ScatterChart(
                                  ScatterChartData(
                                    scatterSpots:
                                        controller.showFlutter ? controller.flutterLogoData() : controller.randomData(),
                                    minX: 0,
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  AnimatedDefaultTextStyle(
                                                    duration: const Duration(milliseconds: 300),
                                                    curve: Curves.easeInToLinear,
                                                    style: TextStyle(color: isSelected ? value.color : Colors.grey),
                              ...
                              child: RadarChart(
                                RadarChartData(
                                  ...
                                  getTitle: (index, angle) {
                                    ...
                                    switch (index) {
                                      case 0:
                                        return RadarChartTitle(text: 'Mobile or Tablet', angle: usedAngle);
                                      case 2:
      ...
      switch (i) {
        case 0:
          return PieChartSectionData(
            ...
            badgeWidget: _Badge('assets/icon/fitness-svgrepo-com.svg', size: widgetSize, borderColor: Colors.black),
        ...
        case 1:
          return PieChartSectionData(
            ...
            badgeWidget: _Badge('assets/icon/librarian-svgrepo-com.svg', size: widgetSize, borderColor: Colors.black),
            badgePositionPercentageOffset: .98,
          );
        case 2:
          return PieChartSectionData(
        ...
        case 3:
          return PieChartSectionData(
            ...
            badgeWidget: _Badge('assets/icon/worker-svgrepo-com.svg', size: widgetSize, borderColor: Colors.black),
            badgePositionPercentageOffset: .98,
          );
        default:
  ...
  Widget build(BuildContext context) {
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: <BoxShadow>[
          BoxShadow(color: Colors.black.withValues(alpha: 0.5), offset: const Offset(3, 3), blurRadius: 3),
        ],
      ),
