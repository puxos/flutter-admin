...
import '../../controller/other/syncfusion_charts_controller.dart';
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    MyText.titleMedium("syncfusion_charts".tr().capitalizeWords, fontSize: 18, fontWeight: 600),
                    MyBreadcrumb(
                      children: [
                                ...
                                AreaSeries<ChartSampleData, String>(
                                  ...
                                  onCreateShader: (ShaderDetails details) {
                                    return ui.Gradient.linear(
                                      ...
                                      <double>[0.1, 0.1, 0.4, 0.4, 0.7, 0.7, 0.9, 0.9],
                                    );
                                  },
                                  xValueMapper: (ChartSampleData data, _) => data.x,
                                  yValueMapper: (ChartSampleData data, _) => data.y,
