...
import '../../controller/other/sfmap_controller.dart';
...
class _SfMapScreenState extends State<SfMapScreen> with SingleTickerProviderStateMixin, UIMixin {
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    MyText.titleMedium("SFMaps", fontSize: 18, fontWeight: 600),
                    MyBreadcrumb(
                      children: [MyBreadcrumbItem(name: 'Maps'), MyBreadcrumbItem(name: 'Sf Map', active: true)],
                    ),
                  ],
                ),
              ),
                              ...
                              layers: <MapLayer>[
                                MapShapeLayer(
                                  ...
                                  tooltipSettings: MapTooltipSettings(
                                    ...
                                    strokeColor:
                                        theme.colorScheme.brightness == Brightness.light ? Colors.white : Colors.black,
                                  ),
                                ),
                              ],
                            ),
