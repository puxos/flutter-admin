...
import '../../controller/ui/carousels_controller.dart';
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    MyText.titleMedium("carousels".tr(), fontSize: 18, fontWeight: 600),
                    MyBreadcrumb(
                      children: [
                        MyBreadcrumbItem(name: 'ui'.tr().toUpperCase()),
                        MyBreadcrumbItem(name: 'carousels'.tr(), active: true),
                      ],
                    ),
                  ],
                ),
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              ...
                              child: MyText.titleMedium('simple'.tr(), fontWeight: 600, letterSpacing: 0),
                            ),
                            Divider(height: 20),
                            Padding(
                              padding: MySpacing.only(left: 16, right: 16, bottom: 16, top: 8),
                      ...
                      child: MyCard(
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              padding: MySpacing.only(left: 16, top: 12),
                              child: MyText.titleMedium('animated'.tr(), fontWeight: 600, letterSpacing: 0),
                            ),
                            Divider(height: 20),
                            Padding(
                              padding: MySpacing.only(left: 16, right: 16, bottom: 16, top: 8),
          ...
          child: PageView(
            ...
            children: <Widget>[
              MyContainer(
                ...
                paddingAll: 0,
                child: Image.asset(Images.landscapeImages[0], fit: BoxFit.fill),
              ),
              MyContainer(
                clipBehavior: Clip.antiAliasWithSaveLayer,
                paddingAll: 0,
                child: Image.asset(Images.landscapeImages[1], fit: BoxFit.fill),
              ),
              MyContainer(
                clipBehavior: Clip.antiAliasWithSaveLayer,
                paddingAll: 0,
                child: Image.asset(Images.landscapeImages[2], fit: BoxFit.fill),
              ),
            ],
          ),
        ),
