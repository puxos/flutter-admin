...
import '../../controller/ui/buttons_controller.dart';
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    MyText.titleMedium("buttons".tr(), fontSize: 18, fontWeight: 600),
                    MyBreadcrumb(
                      children: [
                              ...
                              child: Wrap(
                                ...
                                children: [
                                  MyButton(
                                    ...
                                    child: MyText.bodySmall('primary'.tr(), color: contentTheme.onPrimary),
                                  ),
                                  MyButton(
                                    onPressed: () {},
                                    elevation: 6,
                                    ...
                                    borderRadiusAll: AppStyle.buttonRadius.medium,
                                    child: MyText.bodySmall('secondary'.tr(), color: contentTheme.onSecondary),
                                  ),
                                  MyButton(
                                    onPressed: () {},
                                    elevation: 6,
                                    ...
                                    borderRadiusAll: AppStyle.buttonRadius.medium,
                                    child: MyText.bodySmall('success'.tr(), color: contentTheme.onSuccess),
                                  ),
                                  MyButton(
                                    onPressed: () {},
                                    elevation: 6,
                                  ...
                                  MyButton(
                                    ...
                                    borderRadiusAll: AppStyle.buttonRadius.medium,
                                    child: MyText.bodySmall('danger'.tr(), color: contentTheme.onDanger),
                                  ),
                                ],
                              ),
                            ),
                              ...
                              child: Wrap(
                                ...
                                children: [
                                  MyButton.outlined(
                                    ...
                                    borderRadiusAll: AppStyle.buttonRadius.medium,
                                    child: MyText.bodySmall('primary'.tr(), color: contentTheme.primary),
                                  ),
                                  MyButton.outlined(
                                    onPressed: () {},
                                    elevation: 0,
                                    ...
                                    borderRadiusAll: AppStyle.buttonRadius.medium,
                                    child: MyText.bodySmall('secondary'.tr(), color: contentTheme.secondary),
                                  ),
                                  MyButton.outlined(
                                    onPressed: () {},
                                    elevation: 0,
                                    ...
                                    borderRadiusAll: AppStyle.buttonRadius.medium,
                                    child: MyText.bodySmall('success'.tr(), color: contentTheme.success),
                                  ),
                                  MyButton.outlined(
                                    onPressed: () {},
                                    elevation: 0,
                                    ...
                                    borderRadiusAll: AppStyle.buttonRadius.medium,
                                    child: MyText.bodySmall('warning'.tr(), color: contentTheme.warning),
                                  ),
                                  MyButton.outlined(
                                    onPressed: () {},
                                    elevation: 0,
                              ...
                              child: Wrap(
                                ...
                                children: [
                                  MyButton(
                                    ...
                                    backgroundColor: contentTheme.primary,
                                    borderRadiusAll: AppStyle.buttonRadius.medium,
                                    child: MyText.labelSmall('small'.tr(), color: contentTheme.onPrimary),
                                  ),
                                  MyButton(
                                    onPressed: () {},
                                    elevation: 0,
                                    ...
                                    backgroundColor: contentTheme.primary,
                                    borderRadiusAll: AppStyle.buttonRadius.medium,
                                    child: MyText.bodySmall('medium'.tr(), color: contentTheme.onPrimary),
                                  ),
                                  MyButton(
                                    onPressed: () {},
                                    elevation: 0,
                                    ...
                                    backgroundColor: contentTheme.primary,
                                    borderRadiusAll: AppStyle.buttonRadius.medium,
                                    child: MyText.bodySmall('large'.tr(), color: contentTheme.onPrimary),
                                  ),
                                ],
                              ),
                            ),
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: ToggleButtons(
                                ...
                                borderRadius: BorderRadius.all(Radius.circular(AppStyle.containerRadius.small)),
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        Icon(Icons.wb_sunny_outlined, color: contentTheme.primary, size: 24),
                                        MySpacing.width(12),
                                        MyText.labelLarge('light'.tr(), color: contentTheme.primary),
                                      ],
                                    ),
                                  ),
                                  Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        Icon(Icons.dark_mode_outlined, color: contentTheme.primary, size: 24),
                                        MySpacing.width(12),
                                        MyText.labelLarge('dark'.tr(), color: contentTheme.primary),
                                      ],
                                    ),
                                  ),
                                  Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        Icon(Icons.brightness_6_outlined, color: contentTheme.primary, size: 24),
                                        MySpacing.width(12),
                                        MyText.labelLarge('system'.tr(), color: contentTheme.primary),
                                      ],
                                    ),
                                  ),
                                ],
