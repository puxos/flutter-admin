...
import '../../controller/ui/tab_bar_controller.dart';
...
class _TabScreenState extends State<TabScreen> with TickerProviderStateMixin, UIMixin {
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    MyText.titleMedium("tabs".tr(), fontSize: 18, fontWeight: 600),
                    MyBreadcrumb(
                      children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              ...
                              child: MyText.titleMedium("default_tabs".tr().capitalizeWords, fontWeight: 600),
                            ),
                            Divider(height: 20),
                            Padding(
                      ...
                      child: MyCard(
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              padding: MySpacing.only(left: 16, top: 12),
                              child: MyText.titleMedium("full_width".tr().capitalizeWords, fontWeight: 600),
                            ),
                            Divider(height: 28),
                            Padding(
                              padding: MySpacing.only(left: 16, bottom: 12),
                      ...
                      child: MyCard(
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              padding: MySpacing.only(left: 16, top: 12),
                              child: MyText.titleMedium("background_indicator".tr().capitalizeWords, fontWeight: 600),
                            ),
                            Divider(height: 28),
                            Padding(
                              padding: MySpacing.only(left: 16, bottom: 12),
                      ...
                      child: MyCard(
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              padding: MySpacing.only(left: 16, top: 12),
                              child: MyText.titleMedium("bordered_indicator".tr().capitalizeWords, fontWeight: 600),
                            ),
                            Divider(height: 28),
                            Padding(
                              padding: MySpacing.only(left: 16, bottom: 12),
                      ...
                      child: MyCard(
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              padding: MySpacing.only(left: 16, top: 12),
                              child: MyText.titleMedium("soft_indicator".tr().capitalizeWords, fontWeight: 600),
                            ),
                            Divider(height: 28),
                            Padding(
                              padding: MySpacing.only(left: 16, bottom: 12),
                      ...
                      child: MyCard(
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              padding: MySpacing.only(left: 16, top: 12),
                              child: MyText.titleMedium("${"custom_indicator".tr()} #1", fontWeight: 600),
                            ),
                            Divider(height: 28),
                            Padding(
                              padding: MySpacing.only(left: 16, bottom: 12),
                      ...
                      child: MyCard(
                        ...
                        child: Column(
                          children: [
                            Padding(
                              padding: MySpacing.only(left: 16, top: 12),
                              child: MyText.titleMedium("Custom Indicator #2", fontWeight: 600),
                            ),
