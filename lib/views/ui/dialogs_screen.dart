...
import '../../controller/ui/dialogs_controller.dart';
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    MyText.titleMedium("dialogs".tr(), fontSize: 18, fontWeight: 600),
                    MyBreadcrumb(
                      children: [
                              ...
                              child: Wrap(
                                ...
                                children: [
                                  MyButton(
                                    ...
                                    child: MyText.bodySmall('alert'.tr(), color: contentTheme.onPrimary),
                                  ),
                                  MyButton(
                                    ...
                                    borderRadiusAll: AppStyle.buttonRadius.medium,
                                    child: MyText.bodySmall('standard'.tr(), color: contentTheme.onSuccess),
                                  ),
                                  MyButton(
                      ...
                      child: MyCard(
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              padding: MySpacing.only(left: 16, top: 12),
                              child: MyText.titleMedium('positions'.tr(), fontWeight: 600, letterSpacing: 0),
                            ),
                            Divider(height: 20),
                            Padding(
                              padding: MySpacing.only(left: 16, bottom: 8),
                              child: Wrap(
                                ...
                                children: [
                                  MyButton(
                                    ...
                                    backgroundColor: contentTheme.primary,
                                    borderRadiusAll: AppStyle.buttonRadius.medium,
                                    child: MyText.bodySmall('left'.tr(), color: contentTheme.onPrimary),
                                  ),
                                  MyButton(
                                    ...
                                    backgroundColor: contentTheme.success,
                                    borderRadiusAll: AppStyle.buttonRadius.medium,
                                    child: MyText.bodySmall('top'.tr(), color: contentTheme.onSuccess),
                                  ),
                                  MyButton(
                                    ...
                                    backgroundColor: contentTheme.warning,
                                    borderRadiusAll: AppStyle.buttonRadius.medium,
                                    child: MyText.bodySmall('right'.tr(), color: contentTheme.onWarning),
                                  ),
                                  MyButton(
                                    ...
                                    borderRadiusAll: AppStyle.buttonRadius.medium,
                                    child: MyText.bodySmall('bottom'.tr(), color: contentTheme.onInfo),
                                  ),
                                ],
                              ),
                            ),
                      ...
                      child: MyCard(
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              padding: MySpacing.only(left: 16, top: 12),
                              child: MyText.titleMedium('other'.tr(), fontWeight: 600, letterSpacing: 0),
                            ),
                            Divider(height: 20),
                            Padding(
                              padding: MySpacing.only(left: 16, bottom: 8),
                              child: Wrap(
                                ...
                                children: [
                                  MyButton(
                                    ...
                                    backgroundColor: contentTheme.primary,
                                    borderRadiusAll: AppStyle.buttonRadius.medium,
                                    child: MyText.bodySmall('static'.tr(), color: contentTheme.onPrimary),
                                  ),
                                ],
                              ),
                            ),
    ...
    showDialog(
      ...
      builder: (_) {
        return AlertDialog(
          ...
          content: MyText.bodySmall("are_you_sure,_you_want_to_delete_history?".tr()),
          actions: [
            MyButton.rounded(
              onPressed: () {
              ...
              child: MyText.labelMedium("close".tr(), color: contentTheme.onSecondary),
            ),
            MyButton.rounded(
              onPressed: () {
                Navigator.pop(context);
              ...
              padding: MySpacing.xy(20, 16),
              backgroundColor: contentTheme.primary,
              child: MyText.labelMedium("save".tr(), color: contentTheme.onPrimary),
            ),
          ],
        );
      },
        ...
        return Dialog(
          child: SizedBox(
            ...
            child: Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Padding(padding: MySpacing.all(16), child: MyText.labelLarge('dialog_title'.tr().capitalizeWords)),
        ...
        return Dialog(
          child: Column(
            ...
            children: [
              Padding(padding: MySpacing.all(16), child: MyText.labelLarge('dialog_title'.tr().capitalizeWords)),
              Divider(height: 0, thickness: 1),
              Padding(padding: MySpacing.all(16), child: MyText.bodySmall(controller.dummyTexts[1])),
              Divider(height: 0, thickness: 1),
              Padding(
                padding: MySpacing.all(16),
                child: Row(
        ...
        return Dialog(
          ...
          child: SizedBox(
            ...
            child: Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Padding(padding: MySpacing.all(16), child: MyText.labelLarge('right_dialog'.tr().capitalizeWords)),
                Divider(height: 0, thickness: 1),
                Padding(
                  padding: MySpacing.all(16),
        ...
        return Dialog(
          ...
          child: SizedBox(
            ...
            child: Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Padding(padding: MySpacing.all(16), child: MyText.labelLarge('bottom_dialog'.tr().capitalizeWords)),
                Divider(height: 0, thickness: 1),
                Padding(
                  padding: MySpacing.all(16),
        ...
        return Dialog(
          ...
          child: SizedBox(
            ...
            child: Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Padding(padding: MySpacing.all(16), child: MyText.labelLarge('top_dialog'.tr().capitalizeWords)),
                Divider(height: 0, thickness: 1),
                Padding(
                  padding: MySpacing.all(16),
        ...
        return Dialog(
          ...
          child: SizedBox(
            ...
            child: Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Padding(padding: MySpacing.all(16), child: MyText.labelLarge('left_dialog'.tr())),
                Divider(height: 0, thickness: 1),
                Padding(
                  padding: MySpacing.all(16),
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Row(
                    children: [
                      Expanded(child: MyText.labelLarge('static_dialog'.tr().capitalizeWords)),
                      InkWell(
                        onTap: () => Navigator.pop(context),
                        child: Icon(
                          Icons.close_outlined,
                          size: 20,
                          color: contentTheme.onBackground.withValues(alpha: 0.5),
                        ),
                      ),
                    ],
                  ),
