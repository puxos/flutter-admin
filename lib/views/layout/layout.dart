...
import '../../images.dart';
import '../../views/layout/left_bar.dart';
import '../../views/layout/right_bar.dart';
import '../../views/layout/top_bar.dart';
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          CustomPopupMenu(
            ...
            onChange: (_) {},
            offsetX: -180,
            menu: Padding(padding: MySpacing.xy(8, 8), child: Center(child: Icon(LucideIcons.bell, size: 18))),
          ...
          CustomPopupMenu(
            ...
            menu: Padding(
              ...
              child: MyContainer.rounded(
                paddingAll: 0,
                child: Image.asset(Images.avatars[0], height: 28, width: 28, fit: BoxFit.cover),
              ),
            ),
