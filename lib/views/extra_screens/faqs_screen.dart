...
import '../../controller/extra_screens/faqs_controller.dart';
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    MyText.titleMedium("faqs".tr(), fontSize: 18, fontWeight: 600),
                    MyBreadcrumb(
                      children: [
                        MyBreadcrumbItem(name: 'extra_pages'.tr().capitalizeWords),
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              MyText.titleLarge("FAQs", fontWeight: 600, fontSize: 40),
                              MyButton(
                                onPressed: () {},
                                elevation: 0,
                                ...
                                child: Row(
                                  children: [
                                    MyText.bodySmall('Documentation', color: contentTheme.primary),
                                    MySpacing.width(8),
                                    Icon(LucideIcons.external_link, color: contentTheme.primary, size: 16),
                                  ],
                                ),
                              ),
                            ],
                          ...
                          MySpacing.height(16),
                          MyText.bodyMedium(controller.dummyTexts[1], maxLines: 2, xMuted: true, fontSize: 12),
                          MySpacing.height(80),
                          Padding(
                          ...
                          Row(
                            ...
                            children: [
                              MyButton(
                                ...
                                child: Row(
                                  children: [
                                    Icon(LucideIcons.phone, size: 14, color: contentTheme.onSuccess),
                                    MySpacing.width(10),
                                    MyText.bodySmall('contact_us'.tr().capitalizeWords, color: contentTheme.onSuccess),
                                  ],
                                ),
                              ),
                              MySpacing.width(16),
                              MyButton(
                                ...
                                child: Row(
                                  children: [
                                    Icon(LucideIcons.mail, size: 14, color: contentTheme.onPrimary),
                                    MySpacing.width(12),
                                    MyText.bodySmall('email_us_your_question'.tr(), color: contentTheme.onSuccess),
                                  ],
                                ),
                              ),
                            ],
    ...
    return Row(
      ...
      children: [
        MyContainer(
          ...
          child: Center(child: Icon(icon, size: 16, color: contentTheme.primary)),
        ),
        MySpacing.width(16),
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [MyText.labelLarge(title), MySpacing.height(4), MyText.bodySmall(description, maxLines: 2)],
          ),
        ),
      ],
    );
