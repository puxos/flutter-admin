...
import '../../controller/forms/validation_forms_controller.dart';
...
class _ValidationFormScreenState extends State<ValidationFormScreen> with SingleTickerProviderStateMixin, UIMixin {
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    MyText.titleMedium("validation_forms".tr().capitalizeWords, fontSize: 18, fontWeight: 600),
                    MyBreadcrumb(
                      children: [
                      ...
                      child: MyCard(
                        ...
                        child: Form(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              MyText.labelMedium("full_name".tr().capitalizeWords),
                              MySpacing.height(8),
                              TextFormField(
                                    ...
                                    Gender.values
                                        .map(
                                          (gender) => DropdownMenuItem<Gender>(
                                            value: gender,
                                            child: MyText.labelMedium(gender.name.capitalizeWords),
                                          ),
                                        )
                                        .toList(),
                              ...
                              Row(
                                ...
                                children: [
                                  MyButton(
                                    ...
                                    child: MyText.bodySmall('clear'.tr(), color: contentTheme.onSecondary),
                                  ),
                                  MySpacing.width(16),
                                  MyButton(
