...
import '../../controller/forms/basic_form_controller.dart';
...
class _BasicFormScreenState extends State<BasicFormScreen> with SingleTickerProviderStateMixin, UIMixin {
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    MyText.titleMedium("basic_forms".tr().capitalizeWords, fontSize: 18, fontWeight: 600),
                    MyBreadcrumb(
                      children: [
                              ...
                              child: Column(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Row(
                                      children: [
                                        Icon(LucideIcons.toggle_right, color: contentTheme.primary, size: 16),
                                        MySpacing.width(12),
                                        MyText.titleMedium(
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        MySpacing.height(20),
                                        MyText.labelLarge("other_settings:".tr().capitalizeWords),
                                        MySpacing.height(4),
                                        SwitchListTile(
                                          ...
                                          title: MyText.bodyMedium("set_profile_to_private".tr()),
                                        ),
                                        SwitchListTile(
                                          value: controller.newsletter,
                                          onChanged: controller.changeNewsletterStatus,
                                          visualDensity: getCompactDensity,
                                          controlAffinity: ListTileControlAffinity.leading,
                                          contentPadding: MySpacing.zero,
                                          title: MyText.bodyMedium("opt-in_daily_newsletter_at_the_email".tr()),
                                        ),
                                        MySpacing.height(16),
                                        InkWell(
                                          onTap: () => controller.onChangedChecked(!controller.checked),
                                          child: Row(
                                            children: [
                                              Checkbox(
                                        ...
                                        Align(
                                          ...
                                          child: MyButton(
                                            ...
                                            child: MyText.bodySmall('submit'.tr(), color: contentTheme.onPrimary),
                                          ),
                                        ),
                                      ],
                                    ),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: Row(
                                          children: [
                                            Icon(LucideIcons.layers, color: contentTheme.primary, size: 16),
                                            MySpacing.width(12),
                                            MyText.titleMedium(
                                      ...
                                      Padding(
                                        ...
                                        child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            MyText.labelLarge("date_time_pickers".tr().capitalizeWords),
                                            MySpacing.height(12),
                                            Wrap(
                                              spacing: 16,
                                              runSpacing: 16,
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      MyText.labelMedium(
                                                        controller.selectedDate != null
                                                            ...
                                                            : "select_date".tr().capitalizeWords,
                                                        fontWeight: 600,
                                                        color: contentTheme.primary,
                                                      ),
                                                    ],
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      MyText.labelMedium(
                                                        controller.selectedTime != null
                                                            ...
                                                            : "select_time".tr().capitalizeWords,
                                                        fontWeight: 600,
                                                        color: contentTheme.primary,
                                                      ),
                                                    ],
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      MyText.labelMedium(
                                                        controller.selectedDateTimeRange != null
                                                            ...
                                                            : "select_range".tr().capitalizeWords,
                                                        fontWeight: 600,
                                                        color: contentTheme.primary,
                                                      ),
                                                    ],
                                            ...
                                            Slider(
                                              ...
                                              max: 50,
                                              divisions: 50,
                                              label: controller.slider2.floor().toString(),
                                          ...
                                          children: [
                                            Row(
                                              children: [
                                                SizedBox(
                                                  width: 180,
                                                  child: MyText.labelLarge("floating_label_type".tr().capitalizeWords),
                                                ),
                                                PopupMenuButton(
                                                  ...
                                                  child: MyContainer.bordered(
                                                    ...
                                                    child: Row(
                                                      children: <Widget>[
                                                        MyText.labelMedium(
                                                          controller.floatingLabelBehavior.name.capitalizeWords,
                                                          color: contentTheme.onBackground,
                                                        ),
                                                        Container(
                                            ...
                                            Row(
                                              children: [
                                                SizedBox(
                                                  width: 180,
                                                  child: MyText.labelLarge("border_type".tr().capitalizeWords),
                                                ),
                                                PopupMenuButton(
                                                  ...
                                                  itemBuilder: (BuildContext context) {
                                                    return TextFieldBorderType.values.map((borderType) {
                                                      return PopupMenuItem(
                                                        ...
                                                        height: 32,
                                                        child: MyText.bodySmall(
                                                          borderType.name.capitalizeWords,
                                                          color: contentTheme.onBackground,
                                                          fontWeight: 600,
                                                        ),
                                                      );
                                                  ...
                                                  child: MyContainer.bordered(
                                                    ...
                                                    child: Row(
                                                      children: <Widget>[
                                                        MyText.labelMedium(
                                                          controller.borderType.name.capitalizeWords,
                                                          color: contentTheme.onBackground,
                                                        ),
                                                        Container(
                                                          margin: EdgeInsets.only(left: 4),
                                            ...
                                            Row(
                                              children: [
                                                SizedBox(width: 180, child: MyText.labelLarge("filled".tr())),
                                                Switch(
