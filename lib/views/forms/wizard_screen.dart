...
import '../../controller/forms/wizard_controller.dart';
...
class _WizardScreenState extends State<WizardScreen> with SingleTickerProviderStateMixin, UIMixin {
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    MyText.titleMedium("wizard".tr(), fontSize: 18, fontWeight: 600),
                    MyBreadcrumb(
                      children: [
                  ...
                  child: GestureDetector(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        MySpacing.width(16),
                        MyText.labelMedium("enable_validation".tr().capitalizeWords),
                      ],
                    ),
                  ),
                ),
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: InkWell(
                  ...
                  child: Icon(controller.showPassword ? LucideIcons.eye : LucideIcons.eye_off, size: 18),
                ),
                contentPadding: MySpacing.all(16),
                isCollapsed: true,
                floatingLabelBehavior: FloatingLabelBehavior.never,
              ...
              child: MyButton.rounded(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    MyText.bodySmall('next'.tr(), color: contentTheme.onPrimary),
                  ],
                ),
              ),
            ),
            ...
            Row(
              ...
              children: [
                MyButton.text(
                  ...
                  child: MyText.bodySmall('prev'.tr(), color: contentTheme.secondary),
                ),
                MySpacing.width(8),
                MyButton.rounded(
                  onPressed: () {
                ...
                child: Row(
                  ...
                  children: [
                    controller.loading
                        ...
                        : Container(),
                    if (controller.loading) MySpacing.width(16),
                    MyText.bodySmall('finish'.tr(), color: contentTheme.onPrimary),
                  ],
                ),
              ),
            ],
