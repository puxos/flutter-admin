...
class _SignUpScreenState extends State<SignUpScreen> with SingleTickerProviderStateMixin, UIMixin {
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      MyText.titleLarge('Sign Up', fontSize: 40, muted: true),
                      MySpacing.height(30),
                      ...
                      MySpacing.height(20),
                      MyText.bodyMedium('Email Address'),
                      MySpacing.height(8),
                      TextFormField(
                      ...
                      Center(
                        child: MyButton.block(
                          ...
                          onPressed: () {},
                          child: MyText.bodyMedium('Create account', color: contentTheme.onPrimary),
                        ),
                      ),
                      MySpacing.height(24),
                      Center(
                        child: InkWell(
                          ...
                          child: RichText(
                            text: TextSpan(
                              ...
                              children: [
                                TextSpan(text: 'Sign in', style: MyTextStyle.bodyMedium(color: contentTheme.primary)),
                              ],
                            ),
                          ),
                        ),
