...
class _ResetPasswordScreenState extends State<ResetPasswordScreen> with SingleTickerProviderStateMixin, UIMixin {
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      MyText.titleLarge("reset_password".tr().capitalizeWords, fontWeight: 700),
                      MySpacing.height(10),
                      MyText.bodySmall("your_password_will_be_reset".tr(), muted: true),
                      MySpacing.height(45),
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          suffixIcon: InkWell(
                            ...
                            child: Icon(
                              controller.confirmPassword ? Icons.visibility_off_outlined : Icons.visibility_outlined,
                              size: 20,
                            ),
                          ),
                          contentPadding: MySpacing.all(16),
                      ...
                      Center(
                        child: MyButton.block(
                          ...
                          child: MyText.bodySmall('confirm'.tr(), color: contentTheme.onPrimary),
                        ),
                      ),
                    ],
                  ),
