              ...
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      MyText.titleLarge("forgot_password".tr().capitalizeWords, fontWeight: 700),
                      MySpacing.height(8),
                      MyText.bodySmall("Please reset your password.", muted: true),
                      MySpacing.height(16),
                      ...
                      Center(
                        child: MyButton.text(
                          ...
                          child: MyText.labelMedium('back_to_log_in'.tr(), color: contentTheme.secondary),
                        ),
                      ),
                    ],
                  ),
