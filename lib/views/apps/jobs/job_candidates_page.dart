...
import '../../../controller/apps/jobs/job_candidate_controller.dart';
...
class JobCandidatePage extends StatefulWidget {
  const JobCandidatePage({super.key});

  @override
  State<JobCandidatePage> createState() => _JobCandidatePageState();
}

class _JobCandidatePageState extends State<JobCandidatePage> with SingleTickerProviderStateMixin, UIMixin {
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    MyText.titleMedium("Job Candidate", fontWeight: 600, fontSize: 18),
                    MyBreadcrumb(
                      children: [MyBreadcrumbItem(name: "UI"), MyBreadcrumbItem(name: "Job Candidate", active: true)],
                    ),
                  ],
                ),
              ),
                      ...
                      children: [
                        ...
                        MyContainer.none(
                          ...
                          child: PopupMenuButton(
                            ...
                            itemBuilder: (BuildContext context) {
                              return ["Select Job", "Engineer", "Developer", "Artist", "Lawyer"].map((behavior) {
                            ...
                            child: MyContainer.none(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: <Widget>[
                                  MyText.labelMedium(controller.selectJob.toString()),
                                  Container(
                                    margin: EdgeInsets.only(left: 4),
                                    child: Icon(Icons.expand_more_outlined, size: 22),
                                  ),
                                ],
                              ),
                            ),
                        ...
                        MyContainer.none(
                          ...
                          child: PopupMenuButton(
                            ...
                            itemBuilder: (BuildContext context) {
                              return ["Select Rating", "Ok", "Good", "Better", "Best", "Excellent"].map((behavior) {
                                return PopupMenuItem(
                                  value: behavior,
                                  height: 32,
                                  child: MyText.bodySmall(behavior.toString(), fontWeight: 600),
                            ...
                            child: MyContainer.none(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: <Widget>[
                                  MyText.labelMedium(controller.selectRating.toString()),
                                  Container(
                                    margin: EdgeInsets.only(left: 4),
                                    child: Icon(Icons.expand_more_outlined, size: 22),
                                  ),
                                ...
                                child: Align(
                                  ...
                                  child: MyContainer.none(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Icon(Icons.star_outline, size: 16, color: AppColors.star),
                                        MySpacing.width(4),
                                        MyText.bodyMedium("${controller.jobCandidate[index].rating}", fontSize: 12),
                                      ],
                                    ),
                                  ),
                                ),
                              ...
                              Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    MySpacing.height(8),
                                    MyText.titleSmall(controller.jobCandidate[index].appName),
                                    MySpacing.height(12),
                                    MyButton(
                                      onPressed: () {},
                                      elevation: 0,
                                      ...
                                      child: MyText.bodySmall('View Detail', color: contentTheme.onPrimary),
                                    ),
                                  ],
                                ),
                              ),
