...
import '../../../controller/apps/project/project_detail_controller.dart';
...
class _ProjectDetailState extends State<ProjectDetail> with SingleTickerProviderStateMixin, UIMixin {
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    MyText.titleMedium("Project Detail", fontSize: 18, fontWeight: 600),
                    MyBreadcrumb(
                      children: [
                            ...
                            child: MyCard(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  MySpacing.height(16),
                                  MyContainer.bordered(child: buildFile("WebKit-file-1", 1363148)),
                                  MySpacing.height(16),
                                  MyContainer.bordered(child: buildFile("WebKit-file-2", 10485760)),
                                  MySpacing.height(16),
                                  MyContainer.bordered(child: buildFile("WebKit-file-3", 1610612736)),
                                ],
                              ),
                            ),
                          ),
                            ...
                            child: MyCard(
                              ...
                              child: Column(
                                ...
                                children: [
                                          ...
                                          itemBuilder:
                                              (BuildContext context) => [
                                                ...
                                                PopupMenuItem(
                                                  ...
                                                  child: Row(
                                                    children: [
                                                      Icon(LucideIcons.log_out, size: 16),
                                                      MySpacing.width(8),
                                  ...
                                  MySpacing.height(16),
                                  MyText.titleMedium("Project Reviews :", fontWeight: 600),
                                  MySpacing.height(16),
                                  MyText.bodyMedium(controller.dummyTexts[1], muted: true, maxLines: 3),
                                  MySpacing.height(16),
                                  MyText.bodyMedium(controller.dummyTexts[2], muted: true, maxLines: 3),
                                  MySpacing.height(16),
                                  ...
                                  Wrap(
                                    ...
                                    children: [
                                      Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          MyText.titleMedium("Start Data"),
                                          MySpacing.height(8),
                                          MyText.bodyMedium("17 March 2019 1:00 PM", muted: true),
                                        ],
                                      ),
                                      Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          ...
                                          MySpacing.height(8),
                                          MyText.bodyMedium("22 December 2019 1:00 PM", muted: true),
                                        ],
                                      ),
                                      Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          ...
                                          MySpacing.height(8),
                                          MyText.bodyMedium("\$15,800", muted: true),
                                        ],
                                      ),
                                    ],
                                  ),
                                  ...
                                  Row(
                                    children:
                                        controller.images
                                            .mapIndexed(
                                              (index, element) => MyContainer.roundBordered(
                                                marginAll: 4,
                                                paddingAll: 2,
                                                child: ClipRRect(
                                                  borderRadius: BorderRadius.circular(20),
                                                  child: Image.asset(element, height: 32, width: 32, fit: BoxFit.cover),
                                                ),
                                              ),
                                            )
                                            .toList(),
                              ...
                              child: Column(
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      Expanded(
                                        child: MyText.titleLarge("Comments (258)", overflow: TextOverflow.ellipsis),
                                      ),
                                      MyContainer.none(
                                        paddingAll: 8,
                                        borderRadiusAll: 5,
                                          ...
                                          itemBuilder:
                                              (BuildContext context) => [
                                                PopupMenuItem(
                                                  padding: MySpacing.xy(16, 8),
                                                  height: 10,
                                                  child: MyText.bodySmall("Latest"),
                                                ),
                                                PopupMenuItem(
                                                  padding: MySpacing.xy(16, 8),
                                                  height: 10,
                                                  child: MyText.bodySmall("Popular"),
                                                ),
                                              ],
                                          child: Icon(LucideIcons.ellipsis_vertical, size: 18),
                                        ),
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              MyButton(
                                                ...
                                                child: MyText.bodySmall('Post', color: contentTheme.onPrimary),
                                              ),
                                            ],
                                          ),
                                        ),
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            Column(
                                              ...
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              children: [
                                                MyText.titleMedium("Jeremy Tomlinson", fontWeight: 700, fontSize: 12),
                                                MyText.titleMedium(
                                            ...
                                            Expanded(
                                              child: Column(
                                                ...
                                                children: [
                                                  Row(
                                                    children: [
                                                      MyText.bodyMedium("Kevina Levered ", fontWeight: 600),
                                                      Expanded(
                                                        child: MyText.bodySmall(
                                                          "about 2 minutes ago",
                                                          fontSize: 10,
                                                  ...
                                                  Row(
                                                    children: [
                                                      const Icon(LucideIcons.reply, size: 16),
                                                      MySpacing.width(8),
    ...
    return Row(
      children: [
        ...
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [MyText.bodyMedium(text, fontSize: 16), MyText.bodyMedium(Utils.getStorageStringFromByte(bytes))],
          ),
        ),
  ...
  Widget buildProjectState(Color color, IconData icons, double countUp, String projectStateName) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        MyContainer.rounded(paddingAll: 28, color: color.withAlpha(28), child: Icon(icons, color: color)),
        Expanded(
          child: Column(
            ...
            children: [
              ...
              MySpacing.height(12),
              MyText.bodyMedium(projectStateName, fontSize: 20, overflow: TextOverflow.ellipsis),
            ],
          ),
        ),
      ],
  ...
  Widget buildTagsContainer(String text) {
    return MyContainer(
      ...
      child: Padding(
        padding: MySpacing.xy(8, 2),
        child: MyText.bodyMedium(text, fontSize: 12, fontWeight: 600, color: contentTheme.primary),
      ),
    );
  }
}
