...
import '../../../controller/apps/files/file_upload_controller.dart';
...
class _FileUploadPageState extends State<FileUploadPage> with SingleTickerProviderStateMixin, UIMixin {
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    MyText.titleMedium("File Upload", fontWeight: 600),
                    MyBreadcrumb(
                      children: [MyBreadcrumbItem(name: "UI"), MyBreadcrumbItem(name: "File Upload", active: true)],
                    ),
                  ],
                ),
              ),
              ...
              Padding(
                ...
                child: MyCard(
                  paddingAll: 20,
                  shadow: MyShadow(elevation: 0.75, position: MyShadowPosition.bottom),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      MyText.bodyMedium("Please upload any file to see a previews", fontWeight: 600),
                      MySpacing.height(16),
                      InkWell(
                          ...
                          child: Center(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.center,
                                children: [
                                  Icon(LucideIcons.cloud_upload, size: 24),
                                  MyContainer(
                                    width: 340,
