...
import '../../../controller/apps/files/file_manager_controller.dart';
...
class _FileManagerPageState extends State<FileManagerPage> with SingleTickerProviderStateMixin, UIMixin {
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    MyText.titleMedium("File Manager", fontWeight: 600),
                    MyBreadcrumb(
                      children: [
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        MyContainer.bordered(paddingAll: 5, child: Icon(Icons.list_outlined, size: 18)),
                                        MySpacing.width(6),
                                        MyContainer.bordered(
                                          paddingAll: 5,
                                          child: Icon(Icons.window_outlined, size: 18),
                                        ),
                                        MySpacing.width(6),
                                        MyContainer.bordered(paddingAll: 5, child: Icon(Icons.error_outline, size: 18)),
                                      ],
                                    ),
                                  ],
                                ),
                                ...
                                Wrap(
                                  ...
                                  runSpacing: 16,
                                  children: [
                                    buildFile(Icons.folder_outlined, "WebUi - Zip", 458631),
                                    buildFile(Icons.folder_zip_outlined, "Compile Version", 1458631),
                                    buildFile(Icons.folder_special_outlined, "My Admin", 4358631),
                                    buildFile(Icons.folder_shared_outlined, "Documentation.pdf", 4586531),
                                    buildFile(Icons.source_outlined, "License-details.pdf", 8456312),
                                    buildFile(Icons.folder_outlined, "Purchase Verification", 47856),
                                    buildFile(Icons.folder_zip_outlined, "WebUi Integrations", 125789),
                                  ],
                                ),
                                MySpacing.height(18),
                                MyText.bodyMedium("Recent", fontWeight: 600),
                                MySpacing.height(18),
                                  ...
                                  child: MyContainer.none(
                                    ...
                                    child: DataTable(
                                      ...
                                      columns: [
                                        ...
                                        DataColumn(
                                          label: MyText.labelLarge("Last Modified", color: contentTheme.primary),
                                        ),
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    MyButton(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Icon(Icons.add),
                                          MySpacing.width(8),
                                          MyText.bodySmall('Create New', color: contentTheme.onPrimary),
                                        ],
                                      ),
                                    ),
                                    MySpacing.height(24),
                                    ...
                                    MySpacing.height(16),
                                    buildCreateNew("Google Drive", Icons.add_to_drive),
                                    MySpacing.height(16),
                                    buildCreateNew("Share With Me", Icons.folder_shared_outlined),
                                    MySpacing.height(16),
                                    buildCreateNew("Recent", Icons.access_time_outlined),
                                    MySpacing.height(16),
                                    buildCreateNew("Starred", Icons.star_border),
                                    MySpacing.height(16),
                                    buildCreateNew("Delete File", Icons.auto_delete_outlined),
                                    MySpacing.height(40),
                                    ...
                                    RichText(
                                      text: TextSpan(
                                        children: [
                                          TextSpan(text: '7.02 GB ', style: MyTextStyle.bodyMedium(fontWeight: 700)),
                                          TextSpan(text: '(46%) of  ', style: MyTextStyle.bodyMedium()),
                                          TextSpan(text: '15 GB', style: MyTextStyle.bodyMedium(fontWeight: 700)),
  ...
  buildCreateNew(String fileName, IconData icon) {
    return Row(children: [Icon(icon, size: 24), MySpacing.width(16), MyText.bodyMedium(fileName, fontWeight: 600)]);
  }
    ...
    return DataRow(
      cells: [
        DataCell(
          SizedBox(
            width: 250,
            child: Row(children: [Icon(icon, size: 22), MySpacing.width(16), MyText.bodyMedium(name, fontWeight: 600)]),
          ),
        ),
        DataCell(
          Column(
        ...
        DataCell(MyText.bodyMedium(Utils.getStorageStringFromByte(bytes))),
              ...
              itemBuilder:
                  (BuildContext context) => [
                    PopupMenuItem(
                      ...
                      height: 10,
                      child: Row(
                        children: [Icon(Icons.share_outlined, size: 16), MySpacing.width(8), MyText.bodySmall("Share")],
                      ),
                    ),
                    PopupMenuItem(
                      padding: MySpacing.xy(16, 8),
  ...
  Widget buildFile(IconData icon, String name, int bytes) {
    return MyContainer.bordered(
      ...
      child: Row(
        children: [
          MyContainer(color: contentTheme.onBackground.withAlpha(28), paddingAll: 8, child: Icon(icon, size: 20)),
          MySpacing.width(16),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                MyText.bodyMedium(name, maxLines: 1, overflow: TextOverflow.ellipsis, fontWeight: 600),
