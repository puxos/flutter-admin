...
import '../../../controller/apps/ecommerce/add_product_controller.dart';
...
class _AddProductScreenState extends State<AddProductScreen> with SingleTickerProviderStateMixin, UIMixin {
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    MyText.titleMedium("add_product".tr().capitalizeWords, fontSize: 18, fontWeight: 600),
                    MyBreadcrumb(
                      children: [
                        MyBreadcrumbItem(name: 'ecommerce'.tr()),
                        MyBreadcrumbItem(name: 'add_product'.tr().capitalizeWords, active: true),
                      ],
                    ),
                  ],
                ),
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: Row(
                                children: [
                                  Icon(LucideIcons.server, color: contentTheme.primary, size: 16),
                                  MySpacing.width(12),
                                  MyText.titleMedium("general".tr(), fontWeight: 600, color: contentTheme.primary),
                                ],
                              ),
                            ),
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  MyText.labelMedium("product_name".tr().capitalizeWords),
                                  MySpacing.height(8),
                                  TextFormField(
                                  ...
                                  MySpacing.height(25),
                                  MyText.labelMedium("shop_name".tr().capitalizeWords),
                                  MySpacing.height(8),
                                  TextFormField(
                                            ...
                                            TextFormField(
                                              ...
                                              decoration: InputDecoration(
                                                ...
                                                prefixIcon: MyContainer.none(
                                                  ...
                                                  child: MyText.labelLarge("\$", color: contentTheme.primary),
                                                ),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      MyButton(
                                        ...
                                        child: MyText.bodySmall('save'.tr(), color: contentTheme.onPrimary),
                                      ),
                                    ],
                                  ),
                                ],
