...
import '../../../controller/apps/ecommerce/customers_controller.dart';
...
class _CustomersPageState extends State<CustomersPage> with SingleTickerProviderStateMixin, UIMixin {
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    MyText.titleMedium("customers".tr(), fontSize: 18, fontWeight: 600),
                    MyBreadcrumb(
                      children: [
                        ...
                        children: [
                          MyButton(
                            ...
                            child: Row(
                              ...
                              children: [
                                Icon(LucideIcons.monitor, size: 18, color: contentTheme.onPrimary),
                                MySpacing.width(8),
                                MyText.labelMedium('dashboard'.tr(), color: contentTheme.onPrimary),
                              ],
                            ),
                          ),
                          MySpacing.height(16),
                            ...
                            child: MyContainer.none(
                              ...
                              child: DataTable(
                                ...
                                columns: [
                                  ...
                                  DataColumn(label: MyText.labelLarge('phone'.tr(), color: contentTheme.primary)),
                                  DataColumn(label: MyText.labelLarge('balance'.tr(), color: contentTheme.primary)),
                                                ...
                                                SizedBox(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      MySpacing.width(15),
                                                      MyText.labelLarge(data.firstName.toString()),
                                                      MySpacing.width(5),
                                                      MyText.labelLarge(
