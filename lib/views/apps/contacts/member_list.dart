...
import '../../../controller/apps/contact/member_list_controller.dart';
...
class _MemberListState extends State<MemberList> with SingleTickerProviderStateMixin, UIMixin {
                    ...
                    Row(
                      ...
                      children: [
                        MyButton(
                          ...
                          child: Row(
                            children: [
                              Icon(LucideIcons.circle_plus, color: contentTheme.light, size: 16),
                              MySpacing.width(16),
                              MyText.bodySmall("Add New", color: contentTheme.onPrimary),
                            ],
                          ),
                        ),
                        SizedBox(
                          ...
                          child: Row(
                            children: [
                              MyContainer(
                                ...
                                width: 150,
                                child: Image.asset(controller.discover[index].image, fit: BoxFit.fill),
                              ),
                              Expanded(
                                child: Padding(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          IconButton(
                                            onPressed: () {},
                                            icon: const Icon(LucideIcons.linkedin, color: Color(0xff0A66C2), size: 20),
                                          ),
                                          IconButton(
                                            onPressed: () {},
                                            icon: const Icon(LucideIcons.facebook, color: Color(0xff3b5998), size: 20),
                                          ),
                                          IconButton(
                                            onPressed: () {},
                                            icon: const Icon(LucideIcons.github, color: Color(0xff3b5998), size: 20),
                                          ),
                                        ],
                                      ),
                                    ],
