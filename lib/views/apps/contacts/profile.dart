...
import '../../../controller/apps/contact/profile_controller.dart';
...
class _ProfilePageState extends State<ProfilePage> with SingleTickerProviderStateMixin, UIMixin {
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    MyBreadcrumb(
                      children: [MyBreadcrumbItem(name: "Contact"), MyBreadcrumbItem(name: "Profile", active: true)],
                    ),
                  ],
                ),
              ),
                        ...
                        children: [
                          MyCard(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                MyText.bodyLarge("About Us", fontSize: 20, fontWeight: 600),
                                MySpacing.height(20),
                                        ...
                                        children: [
                                          Row(
                                            children: [
                                              ...
                                              MySpacing.width(8),
                                              MyText.bodyMedium("Live at Andorra"),
                                            ],
                                          ),
                                          MySpacing.height(16),
                                          Row(
                                            children: [
                                              ...
                                              MySpacing.width(8),
                                              MyText.bodyMedium("demo@gmail.com"),
                                            ],
                                          ),
                                        ],
                                      ),
                                    ...
                                    MyFlexItem(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              const Icon(LucideIcons.luggage, size: 20),
                                              MySpacing.width(8),
                                              Expanded(
                                                child: MyText.bodyMedium(
                                    ...
                                    MyFlexItem(
                                      ...
                                      child: Column(
                                        children: [
                                          Row(
                                            children: [
                                              const FaIcon(LucideIcons.facebook, color: Color(0xff3b5998)),
                                              MySpacing.width(12),
                                              Expanded(
                                                child: MyText.bodyMedium(
                                          ...
                                          Row(
                                            children: [
                                              const FaIcon(LucideIcons.instagram, color: Color(0xffE4405F)),
                                              MySpacing.width(12),
                                              Expanded(
                                                child: MyText.bodyMedium(
                                    ...
                                    MyFlexItem(
                                      ...
                                      child: Column(
                                        children: [
                                          Row(
                                            children: [
                                              const FaIcon(LucideIcons.linkedin, color: Color(0xff0A66C2)),
                                              MySpacing.width(8),
                                              Expanded(
                                                child: MyText.bodyMedium(
                                          ...
                                          Row(
                                            children: [
                                              const FaIcon(LucideIcons.twitter, color: Color(0xff00acee)),
                                              MySpacing.width(8),
                                              Expanded(
                                                child: MyText.bodyMedium(
                          ...
                          MyCard(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                MyText.bodyLarge("Reviews", fontSize: 20, fontWeight: 600),
                                MySpacing.height(12),
                                SfCartesianChart(
                          ...
                          children: [
                                  ...
                                  Positioned(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        MySpacing.height(8),
                                        MyText.bodyMedium("@amandasmith", color: contentTheme.onPrimary),
                                      ],
                                    ),
                                  ),
                                  Align(
                            ...
                            Padding(
                              ...
                              child: Wrap(
                                ...
                                spacing: 12,
                                children: [
                                  buildButton("Design", contentTheme.primary.withAlpha(30), contentTheme.primary),
                                  buildButton("Management", contentTheme.primary.withAlpha(30), contentTheme.primary),
                                  buildButton("Ui Design", contentTheme.primary.withAlpha(30), contentTheme.primary),
                                  buildButton("Projects", contentTheme.primary.withAlpha(30), contentTheme.primary),
                                ],
                              ),
                            ),
                            MySpacing.height(12),
                            ...
                            Padding(padding: MySpacing.left(20), child: MyText.titleMedium("Inbox")),
                            // MySpacing.height(12),
                            Padding(
