...
import '../../../controller/apps/contact/edit_profile_controller.dart';
...
class _EditProfileState extends State<EditProfile> with SingleTickerProviderStateMixin, UIMixin {
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: Row(
                                children: [
                                  Icon(LucideIcons.pencil, color: contentTheme.primary, size: 16),
                                  MySpacing.width(12),
                                  MyText.titleMedium("edit_profile".tr(), fontWeight: 600, color: contentTheme.primary),
                                ],
                              ),
                            ),
                            MySpacing.height(16),
                            Padding(
                              ...
                              child: Column(
                                children: [
                                  Row(
                                    children: [
                                      Expanded(child: buildTextField("First Name", "First Name")),
                                      MySpacing.width(12),
                                      Expanded(child: buildTextField("Last Name", "Last Name")),
                                    ],
                                  ),
                                  MySpacing.height(12),
                                  buildTextField("User Name", "User Name"),
                                  MySpacing.height(12),
                                  buildTextField("Profession", "Your Profession"),
                                  MySpacing.height(12),
                              ...
                              child: Column(
                                children: [
                                  ...
                                  MyButton(
                                    ...
                                    backgroundColor: contentTheme.primary,
                                    borderRadiusAll: AppStyle.buttonRadius.medium,
                                    child: MyText.bodySmall('Conform Password', color: contentTheme.onPrimary),
                                  ),
                                  MySpacing.height(16),
                                ],
                              ),
