...
import '../../../controller/apps/todo/done_todo_controller.dart';
...
class _DoneTodoScreenState extends State<DoneTodoScreen> with SingleTickerProviderStateMixin, UIMixin {
  ...
  Widget build(BuildContext context) {
    return GetBuilder(
      ...
      builder: (controller) {
        return Expanded(
          child:
              TodoCache.doneTodo.isEmpty
                  ? Center(child: MyText.bodyMedium("Done Data Is Empty", fontWeight: 600))
                  : ListView.separated(
