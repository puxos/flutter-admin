...
import '../../controller/apps/kanban_controller.dart';
...
class _KanBanScreenState extends State<KanBanScreen> with SingleTickerProviderStateMixin, UIMixin {
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    MyBreadcrumb(
                      children: [MyBreadcrumbItem(name: 'Apps'), MyBreadcrumbItem(name: 'KanBan', active: true)],
                    ),
                  ],
                ),
              ),
          ...
          children: [
            Row(
              ...
              children: [
                MyContainer(
                  ...
                  child: MyText(item.kanbanLevel, fontSize: 12, color: contentTheme.onPrimary),
                ),
            ...
            Row(
              children: [
                ...
                MySpacing.width(16),
                Icon(LucideIcons.messages_square, size: 20),
                MySpacing.width(8),
  ...
  Widget build(BuildContext context) {
    return Align(
      ...
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [Text(widget.item.title, style: const TextStyle(fontSize: 14), textAlign: TextAlign.left)],
        ),
      ),
    );
  }
