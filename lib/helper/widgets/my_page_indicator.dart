            ...
            children: <Widget>[
              Opacity(
                opacity:
                    (viewModel!.activeIndex == viewModel!.pages.length - 1 &&
                        ...
                        : (viewModel!.activeIndex != viewModel!.pages.length - 1 ? 1 : 0)),
              ...
              Expanded(
                ...
                child: Transform(
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.center, children: bubbles),
                ),
              ),
              Opacity(
                opacity:
        ...
        children: <Widget>[
          Container(
            ...
            decoration: BoxDecoration(
              ...
              color:
                  viewModel!.isActive
                      ? viewModel!.selectedIndicatorColor.withAlpha((255 * viewModel!.activePercent!).floor())
                      : viewModel!.unSelectedIndicatorColor,
            ),
            child: Container(),
          ),
