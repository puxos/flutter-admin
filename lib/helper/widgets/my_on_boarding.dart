...
import '../../helper/widgets/my_page_dragger.dart';
import '../../helper/widgets/my_page_indicator.dart';
import '../../helper/widgets/my_page_reveal.dart';
import '../../helper/widgets/my_pages.dart';
...
class _MyOnBoardingState extends State<MyOnBoarding> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          MySinglePage(viewModel: widget.pages[activeIndex], percentVisible: 1.0),
          MyPageReveal(
            revealPercent: slidePercent,
            child: MySinglePage(viewModel: widget.pages[nextPageIndex], percentVisible: slidePercent),
          ),
          MyPagerIndicator(
