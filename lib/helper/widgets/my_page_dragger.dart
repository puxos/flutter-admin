...
class MyPageDragger extends StatefulWidget {
  ...
  const MyPageDragger({super.key, this.canDragLeftToRight, this.canDragRightToLeft, this.slideUpdateStream});

  @override
  State<MyPageDragger> createState() => _MyPageDraggerState();
}
