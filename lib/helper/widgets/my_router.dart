...
import '../../helper/widgets/my_route.dart';
import '../../helper/widgets/my_route_exception.dart';
import '../../helper/widgets/my_routes.dart';
...
class MyRouter {
  static T? getArgs<T>(BuildContext context) {
    try {
      ...
      throw RouteException("Use getArgs in onReady state. Don't use in constructor or initState");
    }
  }
  ...
  static Future<T?> pushNamed<T extends Object?>(BuildContext context, String routeName, {Object? arguments}) async {
  ...
  static Future<T?> pushReplacementNamed<T extends Object?, TO extends Object?>(
    ...
    return Navigator.of(context).pushReplacementNamed<T, TO>(route.name, arguments: arguments);
  }
}
