...
class AppTheme {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    tabBarTheme: TabBarTheme(
      ...
      indicator: UnderlineTabIndicator(borderSide: BorderSide(color: Color(0xff009678), width: 2.0)),
    ),
    ...
    /// Radio theme
    radioTheme: RadioThemeData(fillColor: WidgetStateProperty.all(Color(0xff009678))),
