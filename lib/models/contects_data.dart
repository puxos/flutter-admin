...
class Contacts extends IdentifierModel {
  ...
  Contacts(super.id, this.name, this.phoneNumber, this.email, this.company, this.createdAt, this.image);
  ...
  static Contacts fromJSON(Map<String, dynamic> json) {
    ...
    return Contacts(decoder.getId, name, phoneNumber, email, company, createdAt, image);
  }
  ...
  static Future<String> getData() async {
    return await rootBundle.loadString('assets/data/contact_data.json');
  }
}
