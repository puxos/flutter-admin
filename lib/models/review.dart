...
class Review extends IdentifierModel {
  ...
  Review(super.id, this.name, this.comment, this.totalSpend, this.totalReview, this.image, this.date);
  ...
  static Review fromJSON(Map<String, dynamic> json) {
    ...
    return Review(decoder.getId, name, comment, totalSpend, totalReview, image, date);
  }
