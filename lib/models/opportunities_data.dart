...
class Opportunities extends IdentifierModel {
  ...
  Opportunities(super.id, this.name, this.location, this.category, this.email, this.phoneNumber, this.image);
  ...
  static Opportunities fromJSON(Map<String, dynamic> json) {
    ...
    return Opportunities(decoder.getId, name, location, category, email, phoneNumber, image);
  }
  ...
  static Future<String> getData() async {
    return await rootBundle.loadString('assets/data/opportunities_data.json');
  }
}
