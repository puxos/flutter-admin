  ...
  void onInit() {
    ...
    final group3 = AppFlowyGroupData(
      ...
      items: [
        ...
        TextItem("Medium", Colors.brown, "10 Aug 2018", "Brand Logo Design", "Luce", Images.avatars[7], "Design", 65),
        TextItem(
          "High",
          Colors.red.shade400,
          "16 Aug 2018",
...
class TextItem extends AppFlowyGroupItem {
  ...
  TextItem(this.kanbanLevel, this.color, this.date, this.title, this.name, this.image, this.jobTypeName, this.comment);
