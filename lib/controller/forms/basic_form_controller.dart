...
class BasicFormController extends MyController {
  ...
  bool showPassword = false, checked = false, publicStatus = false, newsletter = true;
  ...
  OutlineInputBorder? get inputBorder {
    ...
    if (borderType == TextFieldBorderType.none) {
      return OutlineInputBorder(borderRadius: BorderRadius.all(Radius.circular(4)), borderSide: BorderSide.none);
    }
    return OutlineInputBorder(borderRadius: BorderRadius.all(Radius.circular(4)));
  }
