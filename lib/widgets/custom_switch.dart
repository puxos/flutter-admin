    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: Border.all(
            color: widget.value ? rightBarTheme.activeSwitchBorderColor : rightBarTheme.onDisabled,
            width: 0.6,
          ),
        ...
        child: Align(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              color: !widget.value ? rightBarTheme.onDisabled : theme.colorScheme.onPrimary,
            ),
          ),
        ),
      ),
